...
def run_uninstall(
    ...
    *,
    ...
    # Generated by setup when a retired provider is migrated out; it is derived
    # runtime state, not a credential, so it is removed with the rest.
    _remove(paths.models_file.with_name("models.pre-retired-providers.yaml"), removed)
